...
public class DietPlanAdapter extends RecyclerView.Adapter {
    ...
    public DietPlanAdapter(Activity activity, String type, List<DietPlanList> dietPlanLists, OnClick onClick) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(activity).inflate(R.layout.diet_plan_adapter, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            ...
            viewHolder.constraintLayout.setLayoutParams(new MaterialCardView.LayoutParams(MaterialCardView.LayoutParams.MATCH_PARENT, (int) (columnWidth / 2.2)));

            Glide.with(activity).load(dietPlanLists.get(position).getDiet_image_thumbnail())
                    .placeholder(R.drawable.place_holder)
                    .into(viewHolder.imageView);

            viewHolder.textView.setText(dietPlanLists.get(position).getDiet_title());
            viewHolder.imageView.setOnClickListener(v -> method.click(position, type, "", dietPlanLists.get(position).getDiet_title(), dietPlanLists.get(position).getId(), "", ""));
    ...
    public int getItemViewType(int position) {
        if (dietPlanLists.size() == position) {
            return VIEW_TYPE_LOADING;
        } else if (dietPlanLists.get(position) == null) {
            return VIEW_TYPE_Ad;
        } else {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            textView = itemView.findViewById(R.id.textView_dietPlan_adapter);
            imageView = itemView.findViewById(R.id.imageView_dietPlan_adapter);
            constraintLayout = itemView.findViewById(R.id.con_dietPlan_adapter);
        }
    }
