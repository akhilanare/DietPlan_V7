...
public class ContactUs extends AppCompatActivity {
            ...
            public void onResponse(@NotNull Call<ContactRP> call, @NotNull Response<ContactRP> response) {
                ...
                try {
                    ...
                    if (contactRP.getStatus().equals("1")) {
                        ...
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ContactUs.this, android.R.layout.simple_spinner_item, strings); // Creating adapter for spinner
    ...
    public void form() {
        ...
        if (contactType.equals(getResources().getString(R.string.select_contact_type)) || contactType.equals("") || contactType.isEmpty()) {
            method.alertBox(getResources().getString(R.string.please_select_contact_type));
